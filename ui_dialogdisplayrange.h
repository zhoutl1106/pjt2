...
public:
    ...
    void setupUi(QDialog *DialogDisplayRange)
    {
        ...
        DialogDisplayRange->setStyleSheet(QLatin1String("QDialog {border-image: url(:/image/tipsBkg.png);}\n"
"QWidget\n"
"{\n"
"    font-size:30px;\n"
"}\n"
...
""));
    ...
    void retranslateUi(QDialog *DialogDisplayRange)
    {
        ...
        toolButton->setText(QApplication::translate("DialogDisplayRange", "...", 0));
        toolButton_2->setText(QApplication::translate("DialogDisplayRange", "...", 0));
        pushButton->setText(QApplication::translate("DialogDisplayRange", "\347\241\256\345\256\232", 0));
        pushButton_2->setText(QApplication::translate("DialogDisplayRange", "\345\217\226\346\266\210", 0));
    } // retranslateUi
