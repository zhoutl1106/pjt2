...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FormAdmin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FormAdmin_t qt_meta_stringdata_FormAdmin = {
    {
QT_MOC_LITERAL(0, 0, 9), // "FormAdmin"
QT_MOC_LITERAL(1, 10, 12), // "switchToPage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "index"
QT_MOC_LITERAL(4, 30, 16), // "getLicenseString"
QT_MOC_LITERAL(5, 47, 3) // "str"

    },
    "FormAdmin\0switchToPage\0\0index\0"
...
void FormAdmin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FormAdmin::switchToPage)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FormAdmin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormAdmin.data,
      qt_meta_data_FormAdmin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FormAdmin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormAdmin.stringdata))
        return static_cast<void*>(const_cast< FormAdmin*>(this));
...
// SIGNAL 0
void FormAdmin::switchToPage(int _t1)
{
