...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FormWelcome_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 32, 12) // "checkLicense"

    },
    "FormWelcome\0switchToPage\0\0index\0"
    "checkLicense"
};
...
void FormWelcome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FormWelcome::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FormWelcome::switchToPage)) {
                *result = 0;
            }
        }
    }
...
void *FormWelcome::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormWelcome.stringdata))
...
// SIGNAL 0
void FormWelcome::switchToPage(int _t1)
{
